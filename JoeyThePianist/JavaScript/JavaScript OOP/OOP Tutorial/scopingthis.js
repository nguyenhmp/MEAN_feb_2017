...
/*
Inside of the private method, this refers to the global Window or 
Node object (depending on which environment you're running the script)! 
...
It’s good training to console.log(this); and console.log(self) // if you've declared it; while we work through this section! 
Instead of self, it's not an uncommon practice to use: var _this = this; or var my = this;.

This won’t be going away, and will be back in force when we deal with Angularjs.